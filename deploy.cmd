...
:: -------------------------------------------
EventCreate /L Application /T Information /ID 100 /SO "FasTnT" /D "Created FasTnT source for logging events" >> "%TEMP%\MyLog.txt" 2>&1
