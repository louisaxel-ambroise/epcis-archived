...
namespace Epcis.Data.Queries
{
    public class SqlEventsRetriever : IEventsRetriever
    {
        ...
        {
            var finalQuery = string.Join(" ", GetEvents, GetEpcs, GetTransactions, GetReadPoints, GetLocations);
        ...
        {
            return row == null ? null : new ReadPoint { Id = row.ReadPointId, CustomFields = row.CustomFields };
        }
